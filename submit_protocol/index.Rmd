...
At [Leek group](https://github.com/leekgroup) we have a diverse group of members with expertise in different areas. To make it easier for others in the group to accomplish some recurrent tasks, we like members of the group write a short protocol for others to follow. This document is a short guide on how to submit a new protocol.
